...
const Switch = ({ label, isOn, toggle, ...rest }) => (
  <SwitchBox {...rest}>
    <XS as="label" className={styles.switchLabel}>
      {label}
    </XS>
    <div className={styles.switchInputBox}>
      <input className={styles.switchInput} type="checkbox" checked={isOn} onChange={toggle} />
